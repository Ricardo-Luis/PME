...
function sidebar_code(book_model)
    ...
    <img src="$(SLASH_PREPATH)/isel_logo.png" style="width: 170px; height: auto; vertical-align: text-top display: inline">
    </a>
    <a href="https://julialang.org/">		
    <img src="$(SLASH_PREPATH)/assets/julia-logo.svg" style="margin-left:1em; width: 80px; height: auto; vertical-align: text-bottom; display: inline">
    </a>
